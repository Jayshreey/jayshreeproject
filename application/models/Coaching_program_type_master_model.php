...
class Coaching_program_type_master_model extends CI_Model{



	public function save_coaching_program_type($coaching_program_type_insert_array)
	{
		$this->db->insert('coaching_program_type_master',$coaching_program_type_insert_array);
		$coaching_program_type_id = $this->db->insert_id();

		return $coaching_program_type_id;
	}
	...
	public function get_coaching_program_type_details($coaching_program_type_id)
	{
		$this->db->select('*');
		$this->db->from('coaching_program_type_master');
		//$this->db->join('','','');
		$where = '(entity_id = "'.$coaching_program_type_id.'")';
		$this->db->where($where);
		$coaching_program_type_query = $this->db->get();
		$coaching_program_type_details = $coaching_program_type_query->row();

		return $coaching_program_type_details;
	}
    ...
    public function update_coaching_program_type($coaching_program_type_id,$update_coaching_program_type_update_array)
    {
        $this->db->where('entity_id', $coaching_program_type_id);
        return $this->db->update('coaching_program_type_master', $update_coaching_program_type_update_array);
    }
