...
class Daily_diary_master_model extends CI_Model{



	public function save_daily_diary($daily_diary_insert_array)
	{
		$this->db->insert('daily_diary_master',$daily_diary_insert_array);
	...
	{
		return $this->db->insert('daily_diary_attachment_relation',$daily_diary_attachment_insert_array);
	}
	...
	{
		$this->db->select('daily_diary_master.*,concat(sparrow_employee_master.first_name," ",sparrow_employee_master.last_name) as sparrow_employee_name');
		$this->db->from('daily_diary_master');
		$this->db->join('sparrow_employee_master','sparrow_employee_master.entity_id = daily_diary_master.sparrow_employee_id','inner');
		$this->db->order_by('daily_diary_master.diary_date','desc');
