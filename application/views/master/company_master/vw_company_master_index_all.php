					...
					<div class="col-xl-12">
						<div class="card custom-card">
							<div class="card-header">
								<div class="card-title">ECS Company Reservoir [ Active + Archived ]</div>
							</div>
							<div class="card-body">
								<div class="btn-list">
									<a href="vw_company_master" class="btn btn-outline-secondary btn-wave ">
										Active Companies
									</a>
								</div>
							</div>
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td>
															<a href="<?php echo site_url('edit_company_master/' . $entity_id); ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
