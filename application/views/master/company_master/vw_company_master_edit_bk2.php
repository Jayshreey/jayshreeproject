...
<body>
	...
	<div class="page">
		...
		<div class="main-content app-content">
			<div class="container-fluid">
					...
					<div class="my-auto">
						...
						<nav>
							<ol class="breadcrumb mb-0">
								...
								<li class="breadcrumb-item"><a href="<?php echo base_url() . 'vw_customer_master' ?>">Company Master</a></li>
				...
				<form role="form" name="customer_master" action="<?php echo site_url('participants/company_master/edit_customer_master_data'); ?>" method="post">
						...
						<div class="col-xl-12">
							<div class="card custom-card">
								...
								<div class="card-body">
									<div class="row gy-4">
										...
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											...
											<textarea class="form-control" id="address" name="address" rows="3" placeholder="Enter Company Address" value="<?php echo $company_details->address; ?>" required></textarea>
										</div>
										...
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											...
											<select class="form-control" id="city_id" name="city_id" required>
												<option value="<?php echo $company_details->city_id;; ?>"><?php echo $company_details->city_id;; ?></option>
											</select>
										</div>
											...
											<tbody>
												...
												?>
													<tr>
														...
														<td>
															<select class="js-example-basic-single salutation" id="salutation" name="salutation" style="width: 100px;" onchange="save_participant_line(this);" required>
														...
														<td>
															<select class="js-example-basic-single gender" id="gender" name="gender" style="width: 100px;" onchange="save_participant_line(this);" required>
																<option value="">No Selected</option>
														...
														<td>
															<select class="js-example-basic-single spoc_id" id="spoc_id" name="spoc_id" style="width: 100px;" onchange="save_participant_line(this);" required>
																<option value="">No Selected</option>
																<?php foreach ($spoc_list as $spoc) : ?>
																	<option value="<?php echo $spoc->entity_id; ?>" <?= ($spoc->entity_id == $row->spoc_id) ? "selected" : ""; ?>><?php echo $spoc->spoc_name; ?></option>
																<?php endforeach; ?>
															</select>
														</td>
														<td>
														...
														<td>
															<input type="text" required class="form-control joining_date" value="<?php echo $row->joining_date; ?>" id="joining_date" name="joining_date" style="width: 150px;" onchange="save_participant_line(this);">
														</td>
														<!-- <td>
															<select class="js-example-basic-single level" id="level" name="level" style="width: 100px;" onchange="save_participant_line(this);" required>
																<option value="">No Selected</option>
														...
														<td>
															<select class="js-example-basic-single status" id="status" name="status" style="width: 100px;" onchange="save_participant_line(this);" required>
																<option value="">No Selected</option>
								...
								<div class="card-body">
									<div class="row gy-4">
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											<p class="fw-semibold mb-2">State</p>
											<select class="js-example-basic-single" style="width: 100%;" id="customer_status" name="customer_status" required>
												<option value="">No Selected</option>
										...
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											<label for="input-date" class="fw-semibold mb-2">Created Date</label>
											<input type="date" class="form-control" name="created_date" id="created_date" disabled>
										</div>
									</div>
								</div>
								<div class="card-body">
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h6 class="modal-title">Participant Details
					</h6>
					<button type="button" class="btn-close" data-bs-dismiss="modal"
						aria-label="Close"></button>
				</div>
				<div class="modal-body">
				<form role="form" name="customer_master" action="<?php echo site_url('participants/company_master/add_new_participant'); ?>" method="post">
				...
				<input type="hidden" name="pop_up_company_id" value="<?php echo $company_id; ?>" >
					...
					<div class="row gy-4">
						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
							...
							<input type="text" class="form-control" name="pop_up_salutation" id="pop_up_salutation" placeholder="Enter Salutation" required>
						</div>
						...
						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
							...
							<input type="date" class="form-control" name="pop_up_joining_date" id="pop_up_joining_date" placeholder="Enter Joining Date" required>
						</div>
						
						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
						<label for="input-placeholder" class="fw-semibold mb-2">SPOC<span style="color: #FF0000;">*</span></label>
						<select class="form-select pop_up_spoc_id" id="pop_up_spoc_id" name="pop_up_spoc_id" >
							<option value="">No Selected</option>
							<?php foreach ($spoc_list as $spoc) : ?>
					...
					<button type="submit" name="add_address" id="add_address" class="btn btn-primary">Add Participant</button>
				</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#state_id').change(function() {
				var id = $(this).val();
				$.ajax({
					url: "<?php echo site_url('participants/company_master/get_city_name'); ?>",
					method: "POST",
					data: {
						id: id
					},
	...
	<script type="text/javascript">
		$(document).on('click', '#add_address', function() {
			...
			if (customer_name != "" && source != "" && customer_type != "" && address != "" && state_id != "" && customer_pin_code != "" && contact_person != "" && contact_person_email_id != "" && first_contact_no != "" && salutation != "") {
				...
				$.ajax({
					url: "<?php echo site_url('participants/company_master/update_customer_contact_details'); ?>",
					type: "POST",
					data: {
						'entity_id': entity_id,
						'address': address,
	...
	<script type="text/javascript">
		function save_participant_line(item) {
		 ...
		 $.ajax({
		     url: "<?php echo site_url('participants/company_master/update_party_name'); ?>",
		     method: "POST",
		     data: {
		...
		function change_state(item) {
			...
			$.ajax({
				url: "<?php echo site_url('participants/company_master/update_state'); ?>",
				method: "POST",
				data: {
					'state_id': state_id,
					'address_relation_entity_id': address_relation_entity_id
		...
		function change_city(item) {
			...
			$.ajax({
				url: "<?php echo site_url('participants/company_master/update_city'); ?>",
				method: "POST",
				data: {
					'city_id': city_id,
		...
		function change_address(item) {
			...
			$.ajax({
				url: "<?php echo site_url('participants/company_master/update_address'); ?>",
				method: "POST",
				data: {
					'address': address,
					'cust_entity_id': cust_entity_id
		...
		function change_pincode(item) {
			...
			$.ajax({
				url: "<?php echo site_url('participants/company_master/update_pincode'); ?>",
				method: "POST",
				data: {
					'pin_code': pin_code,
					'cust_entity_id': cust_entity_id
		...
		function change_statecode(item) {
			...
			$.ajax({
				url: "<?php echo site_url('participants/company_master/update_statecode'); ?>",
				method: "POST",
				data: {
		...
		function change_gstnumber(item) {
			...
			$.ajax({
				url: "<?php echo site_url('participants/company_master/update_gstnumber'); ?>",
				method: "POST",
				data: {
					'gst_no': gst_no,
					'cust_entity_id': cust_entity_id
		...
		function change_pannumber(item) {
			...
			$.ajax({
				url: "<?php echo site_url('participants/company_master/update_pannumber'); ?>",
				method: "POST",
				data: {
					'pan_no': pan_no,
					'cust_entity_id': cust_entity_id
		...
		function change_contactperson(item) {
			...
			$.ajax({
				url: "<?php echo site_url('participants/company_master/update_contactperson'); ?>",
				method: "POST",
				data: {
					'contact_person': contact_person,
		...
		function change_spoc(item) {
			...
			$.ajax({
				url: "<?php echo site_url('participants/company_master/update_spoc_id'); ?>",
				method: "POST",
				data: {
					'spoc_id': spoc_id,
					'contact_entity_id': contact_entity_id
		...
		function change_emailid(item) {
			...
			$.ajax({
				url: "<?php echo site_url('participants/company_master/update_emailid'); ?>",
				method: "POST",
				data: {
					'email_id': email_id,
					'contact_entity_id': contact_entity_id
		...
		function change_contactnumber(item) {
			...
			$.ajax({
				url: "<?php echo site_url('participants/company_master/update_contactnumber'); ?>",
				method: "POST",
				data: {
		...
		function change_alternatecontactnumber(item) {
			...
			$.ajax({
				url: "<?php echo site_url('participants/company_master/update_alternatecontactnumber'); ?>",
				method: "POST",
				data: {
		...
		function change_whatsupcontactnumber(item) {
			...
			$.ajax({
				url: "<?php echo site_url('participants/company_master/update_whatsupcontactnumber'); ?>",
				method: "POST",
				data: {
