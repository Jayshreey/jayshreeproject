									...
									<div class="row gy-4">
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											...
											<select class="js-example-basic-single"  data-trigger id="role_id" name="role_id" required>
												...
												<option value="5" <?php if($userProfileData['Role ID'] =="5") echo 'selected="selected"'; ?> >Company BH</option>
												<option value="6" <?php if($userProfileData['Role ID'] =="6") echo 'selected="selected"'; ?> >Company RM</option>
												<option value="7" <?php if($userProfileData['Role ID'] =="7") echo 'selected="selected"'; ?> >Company Staff</option>
											</select>
										</div>

										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                            <p class="fw-semibold mb-2">User<span style="color: #FF0000;">*</span></p>
                                            <input type="email" class="form-control" name="email_id" id="email_id" placeholder="Enter Email Address" disabled value="<?php echo $userProfileData['Company Name'].' - '.$userProfileData['First Name'].' '.$userProfileData['Last Name']; ?>">
                                        </div>

										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											<label for="input-email" class="fw-semibold mb-2">Email <span style="color: #FF0000;">*</span></label>
											<input type="email" class="form-control" name="email_id" id="email_id" placeholder="Enter Email Address" value="<?php echo $userProfileData['User Name'];?>" disabled>
										</div>
									</div>
									<br>
									<div class="row mb-3">
