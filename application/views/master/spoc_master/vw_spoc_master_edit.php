		...
		<div class="main-content app-content">
			<div class="container-fluid">
					...
					<div class="my-auto">
						...
						<nav>
							<ol class="breadcrumb mb-0">
								...
								<li class="breadcrumb-item"><a href="<?php echo base_url() . 'vw_batch_master' ?>">SPOC Master</a></li>
								<li class="breadcrumb-item active" aria-current="page">SPOC Master Form</li>
							</ol>
						</nav>
					</div>
				</div>
				...
				<form role="form" name="customer_master" action="<?php echo site_url('master/company_master/edit_customer_master_data'); ?>" method="post">
					...
					<input type="hidden" id="spoc_id" name="spoc_id" value="<?php echo $spoc_id ?>" required>
											...
											<!-- <div class="card custom-card"> -->
												...
												<div class="card-body">
													<dl class="row mb-0">
														...
														<dt class="col-sm-4">SPOC Name</dt>
														<dd class="col-sm-8 company_name" id="company_name" ><?php echo $spoc_details->first_name." ".$spoc_details->last_name ?></dd>
													...
													<dl class="row mb-0">
														...
														<dd class="col-sm-6 account_type" ><?php echo $spoc_details->remark; ?></dd>
									...
									<div class="table-responsive">
										<table id="example1" class="table table-bordered text-nowrap w-100">
											...
											<tbody>
												...
												foreach ($spoc_company_contact_list as $row) :
													$no++;
