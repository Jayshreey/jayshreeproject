	...
	<div class="page">
		...
		<div class="main-content app-content">
			<div class="container-fluid">
					...
					<div class="my-auto">
						...
						<nav>
							<ol class="breadcrumb mb-0">
								...
								<li class="breadcrumb-item"><a href="vw_company_master">SPOC Master</a></li>
								<li class="breadcrumb-item active" aria-current="page">Create SPOC Master</li>
							</ol>
						</nav>
					</div>
				</div>
				...
				<form role="form" name="customer_master" action="<?php echo site_url('master/spoc_master/save_spoc'); ?>" method="post">
					<div class="row">
						<div class="col-xl-12">
							<div class="card custom-card">
								<div class="card-header">
									<div class="card-title">SPOC Master Form</div>
								</div>
								<div class="card-body">
									...
									<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											...
											<select class="js-example-basic-single" data-trigger id="sparrow_employee_id" name="sparrow_employee_id" required>
												<option value="">Select Sparrow Employee</option>
