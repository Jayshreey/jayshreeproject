		...
		<div class="main-content app-content">
			<div class="container-fluid">
				...
				<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
					<div class="my-auto">
						<h5 class="page-title fs-21 mb-1">Training Assistant Master</h5>
						<nav>
							<ol class="breadcrumb mb-0">
								<li class="breadcrumb-item"><a href="javascript:void(0);">Sparrow's Sprout Team</a></li>
								<li class="breadcrumb-item active" aria-current="page">Training Assistant Master</li>
							</ol>
						</nav>
					</div>
				</div>
					...
					<div class="col-xl-12">
						<div class="card custom-card">
							<div class="card-header">
								<div class="card-title">Training Assistant Master</div>
							</div>
							<div class="card-body">
								<div class="btn-list">
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td>
														<a href="<?php echo site_url('edit_spoc_master/'.$sparrow_employee_id); ?>" class="btn btn-sm btn-info" title="Edit"><i class="fas fa-edit"></i></a>
