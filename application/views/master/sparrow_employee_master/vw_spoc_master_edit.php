					...
					<div class="row">
						<div class="col-xl-12">
							...
							<hr>
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td>
														<div class="btn-group">
															<a href="<?php echo site_url('edit_company_master/' . $company_id); ?>" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
														</div>
													</td>
												</tr>
											<?php endforeach; ?>
								...
								<div class="card-body">
									<center>
										<a href="<?php echo base_url('vw_spoc_master'); ?>" class="btn btn-primary" >Close</a>
									</center>
								</div>
