					...
					<div class="col-xl-12">
						<div class="card custom-card">
							<div class="card-header">
								<div class="card-title">Sparrow's Sprout Team Master</div>
							</div>
							<div class="card-body">
								<div class="btn-list">
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td>
														<a href="<?php echo site_url('edit_sparrow_employee/'.$sparrow_employee_id); ?>" class="btn btn-sm btn-info" title="Edit"><i class="fas fa-edit"></i></a>
													</td>
