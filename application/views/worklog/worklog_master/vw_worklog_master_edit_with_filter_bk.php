...
<body>
																...
																<tbody>
																	...
																	foreach ($session_participant_list as $row2):
																		...
																		<tr>
																			...
																			<td>
																				<?php echo $row2->spoc_name; ?>
																			</td>
																			<td>
																				<?php echo $row2->joining_date; ?>
																			</td>
																			<td>
																				<?php echo ($row2->leaving_date < $end_date) ? "<span class='text-danger' >" . $row2->leaving_date . "</span>" : $row2->leaving_date; ?>
																			</td>
																			<td>
													...
													<tbody>
														...
														?>
															<tr>
																...
																<td>
																	<?php echo $row->company_contact_name; ?>
																</td>
																<td>
								...
								<div class="row" id="tracking_info" style="display: none;">
									<div class="col-xl-12">
										...
										<div class="card-body">
											...
											<div class="table-responsive">
												<table id="example12" class="table table-bordered text-nowrap w-100">
													<thead>
														<tr>
															<th>Sr. No.</th>
															<th>Prospect Name</th>
	...
	<script>
		$(function() {
			//$("#example1").DataTable();
			var table=new DataTable('#example12', {
				initComplete: function () {
					this.api()
						...
						.every(function (d) {
							...
							var theadname = $("#example12 th").eq([d]).text(); 
			...
			$("#example12 th select").addClass('form-select selected-option');
			$('#example12 thead input').on('keyup', function() {
			...
			var table1=new DataTable('#example14', {
    		initComplete: function () {
        	this.api()
            ...
            .every(function (d) {
                ...
                // Create select element
                let select = document.createElement('select');
				var theadname = $("#example14 th").eq([d]).text(); 
			...
			$("#example14 th select").addClass('form-select selected-option');
			var table2=new DataTable('#example16', {
    		initComplete: function () {
        	this.api()
            ...
            .every(function (d) {
                ...
                // Create select element
                let select = document.createElement('select');
				var theadname = $("#example16 th").eq([d]).text(); 
			...
			$("#example16 th select").addClass('form-select selected-option');
			$('#example2').DataTable({
				"paging": true,
				"lengthChange": false,
				"searching": true,
