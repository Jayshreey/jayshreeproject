					...
					<div class="my-auto">
						...
						<nav>
							<ol class="breadcrumb mb-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Session Template Master</li>
							</ol>
						</nav>
					</div>
				</div>
					...
					<div class="col-xl-12">
						<div class="card custom-card">
							<div class="card-header">
								<div class="card-title">Session Template Master</div>
							</div>
							<div class="card-body">
								<div class="btn-list">

									<a href= '<?php echo base_url("create_session_template"); ?>' class="btn btn-primary btn-wave">
								...
								<div class="table-responsive">
									<table id="example1" class="table table-bordered text-nowrap w-100">
										<thead>
											<tr>
												<th>Sr. No.</th>
												<!-- <th>Session Template Code</th> -->
												<th>Session Template Name</th>
												<th>Coaching Program Type</th>
												<th>Session Type</th>
										...
										<tbody>
											<?php
											$no = 0;
											// echo '<pre>'; print_r($session_template_list);die;
											foreach ($session_template_list as $row) :
												$no++;
												$session_template_id = $row->entity_id;
											?>
												<tr>
													<td><?php echo $no; ?></td>
													<!-- <td>
														<?php echo $row->session_template_code; ?>
													</td> -->
													<td>
														<?php echo $row->session_template_name; ?>
													</td>
													<td>
														<?php echo ($row->coaching_program_type_id ==1)? "LSDP" : "SSDP"; ?>
													</td>
													<td>
													...
													<td>
														<?php echo $row->process_name; ?>
													</td>
													<td>
														<?php echo $row->topic; ?>
													</td>
													<td>
														<?php echo $row->session_objective; ?>
													</td>
												<td>
														<a href="<?php echo site_url('edit_session_template_master/'.$session_template_id); ?>" class="btn btn-sm btn-info" data-bs-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
													</td>
