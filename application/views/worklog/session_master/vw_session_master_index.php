					...
					<div class="col-xl-12">
						<div class="card custom-card">
							<div class="card-header">
								<div class="card-title">Session Master</div>
							</div>
							<div class="card-body">
								<div class="btn-list">

									<a href="create_session" class="btn btn-primary btn-wave">
										Add Session
									</a>
								</div>
							</div>
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td>
														<!-- <a href="<?php //echo site_url('edit_session_master/'.$session_id); ?>" class="btn btn-sm btn-info" title="Edit"><i class="fas fa-edit"></i></a>
														 -->
														<a href="<?php echo site_url('edit_session_template_master_pg2/'.$session_id); ?>" class="btn btn-sm btn-info" title="Edit"><i class="fas fa-edit"></i></a>
														
														<a href="<?php echo site_url('delete_session_master/'.$session_id); ?>" onclick="return confirm('Are you sure you want to delete this session?');" class="btn btn-sm btn-info" title="Delete"><i class="fas fa-trash"></i></a>
