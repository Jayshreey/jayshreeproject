						...
						<div class="card custom-card">
							...
							<div class="card-body">
								<div class="btn-list">
									...
									<a href="create_daily_diary_master" class="btn btn-primary btn-wave">
										Add Daily Diary
									</a>
								</div>
							</div>
									...
									<table id="example1" class="table table-bordered text-nowrap w-100">
										...
										<tbody>
											...
											foreach ($daily_diary_list as $row) :
												...
												$this->db->select('*');
												$this->db->from('daily_diary_attachment_relation');
											...
											?>
												...
												<!-- <td>
														<a href="<?php echo site_url('edit_daily_diary_master/'.$daily_diary_id); ?>" class="btn btn-sm btn-info" title="Edit"><i class="fas fa-edit"></i></a>
													</td> -->
