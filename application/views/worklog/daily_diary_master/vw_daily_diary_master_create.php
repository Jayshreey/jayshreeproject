	...
	<div class="page">
		...
		<div class="main-content app-content">
			<div class="container-fluid">
				...
				<form role="form" name="customer_master" action="<?php echo site_url('worklog/daily_diary_master/save_daily_diary_details'); ?>" method="post"  enctype="multipart/form-data">
					<div class="row">
						<div class="col-xl-12">
