						...
						<div class="col-xl-12">
							<div class="card custom-card">
								...
								<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											<p class="fw-semibold mb-2">Coaching Program Type<span style="color: #FF0000;"></span></p>
											<select class="form-select" id="coaching_program_type_id" name="coaching_program_type_id" required>
												<option value="">Select Coaching Program Type</option>
												<?php foreach ($coaching_program_type_list as $coaching_program_type) : ?>
													<option value="<?php echo $coaching_program_type->entity_id; ?>" <?php echo ($coaching_program_details->entity_id == $coaching_program_type->entity_id)? "selected" : ""; ?>><?php echo $coaching_program_type->coaching_program_type; ?></option>
												<?php endforeach; ?>
											</select>
										</div>
										...
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											...
											<input type="text" class="form-control" name="coaching_program_name" id="coaching_program_name" placeholder="Enter Coaching Program Name" value="<?php echo $coaching_program_details->coaching_program_name; ?>" required>
										</div>


										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											<label for="input-placeholder" class="fw-semibold mb-2">Remark<span style="color: #FF0000;">*</span></label>
											<input type="text" class="form-control" name="remark" id="remark" placeholder="Enter Remark" value="<?php echo $coaching_program_details->remark; ?>" >
										</div>
										...
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											...
											<select class="form-select" id="status" name="status" required>
												...
												<option value="1" <?php echo ($coaching_program_details->entity_id == 1)? "selected" : ""; ?>>Active</option>
												<option value="2" <?php echo ($coaching_program_details->entity_id == 2)? "selected" : ""; ?>>In-Active</option>
											</select>
										</div>
