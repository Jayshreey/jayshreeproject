					...
					<div class="col-xl-12">
						<div class="card custom-card">
							<div class="card-header">
								<div class="card-title">ECS Reservoir [ Valid + Pending ]</div>
							</div>
							<div class="card-body">
								<div class="btn-list">
									...
									<div class="btn-group">
										...
										<a href="create_participant_master/1" class="btn btn-primary btn-wave ">
											Add Participant
										</a>

										<a href="vw_participant_master_all" class="btn btn-outline-secondary btn-wave ">
											Valid + Pending + In-valid Participants
										</a>
										...
										<tbody>
											...
											foreach ($participant_list as $row) :
												...
												switch ($coaching_program_id) {
													...
													$where = '(session_master.actionable_id = 3 and batch_master.coaching_program_type_id = 1  and session_participant_relation.entity_id = "'.$company_contact_id.'")';
													$this->db->where($where);
													$query = $this->db->get();
													...
													$this->db->join('batch_master','batch_master.entity_id = session_master.batch_id','inner');
													$this->db->join('session_participant_relation','session_participant_relation.session_id = session_master.entity_id','inner');
													$where = '(session_master.actionable_id = 3 and batch_master.coaching_program_type_id = 2  and session_participant_relation.entity_id = "'.$company_contact_id.'")';
											...
											?>
												<tr>
													...
													<td>
														<?php echo $lsdp_session_count; ?>
													</td>
													<td>
														<?php echo $ssdp_session_count; ?>
													</td>
													<td>
														<?php echo $validity; ?>
													</td>
