		...
		<div class="main-content app-content">
			<div class="container-fluid">
				...
				<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
					<div class="my-auto">
						<h5 class="page-title fs-21 mb-1">Coaching Program Type Master</h5>
						<nav>
							<ol class="breadcrumb mb-0">
								<li class="breadcrumb-item" aria-current="page"> Master</li>
								<li class="breadcrumb-item"><a href="<?php echo base_url() . 'vw_batch_master' ?>">Coaching Program Type Master</a></li>
								<li class="breadcrumb-item active" aria-current="page">Coaching Program Type Master Form</li>
							</ol>
						</nav>
					</div>
				</div>
				...
				<form role="form" name="customer_master" action="<?php echo site_url('participants/coaching_program_type_master/update_coaching_program_type'); ?>" method="post">
					<input type="hidden" id="coaching_program_type_id" name="coaching_program_type_id" value="<?php echo $coaching_program_type_id ?>" required>
					<div class="row">
						<div class="col-xl-12">
										...
										<div class="col-xl-12">
											...
											<div class="card-header justify-content-between">
												<div class="card-title">
													Coaching Program Type Information
												</div>
											...
											<div class="card-body">
												...
												<div class="row gy-4">
													...
													<input type="hidden" class="form-control" name="coaching_program_type_id" id="coaching_program_type_id" placeholder="Enter Coaching Program Type" value="<?php echo $coaching_program_type_id; ?>" required>

													<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
														<label for="input-placeholder" class="fw-semibold mb-2">Coaching Program Type<span style="color: #FF0000;">*</span></label>
														<input type="text" class="form-control" name="coaching_program_type" id="coaching_program_type" placeholder="Enter Coaching Program Type" value="<?php echo $coaching_program_type_details->coaching_program_type; ?>" required>
													</div>
													...
													<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
														...
														<select class="form-select" id="status" name="status" required>
															...
															<option value="1" <?php echo ($coaching_program_type_details->status ==1)? "selected" : ""; ?>>Active</option>
															<option value="2" <?php echo ($coaching_program_type_details->status ==2)? "selected" : ""; ?>>In-Active</option>
														</select>
													</div>
