	...
	<div class="page">
		...
		<div class="main-content app-content">
			<div class="container-fluid">
					...
					<div class="my-auto">
						...
						<nav>
							<ol class="breadcrumb mb-0">
								...
								<li class="breadcrumb-item"><a href="vw_company_master">Coaching Program Type Master</a></li>
								<li class="breadcrumb-item active" aria-current="page">Create Coaching Program Type Master</li>
							</ol>
						</nav>
					</div>
				</div>
				...
				<form role="form" name="customer_master" action="<?php echo site_url('participants/coaching_program_type_master/save_coaching_program_type_details'); ?>" method="post">
					<div class="row">
						<div class="col-xl-12">
							<div class="card custom-card">
								<div class="card-header">
									<div class="card-title">Coaching Program Type Master Form</div>
								</div>
								<div class="card-body">
									...
									<div class="row gy-4">
										...
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											...
											<input type="text" class="form-control" name="coaching_program_type" id="coaching_program_type" placeholder="Enter Coaching Program Type" required>
										</div>
