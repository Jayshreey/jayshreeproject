					...
					<div class="my-auto">
						...
						<nav>
							<ol class="breadcrumb mb-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Coaching Program Type Master</li>
							</ol>
						</nav>
					</div>
				</div>
					...
					<div class="col-xl-12">
						<div class="card custom-card">
							<div class="card-header">
								<div class="card-title">Coaching Program Type Master</div>
							</div>
							<div class="card-body">
								<div class="btn-list">

									<a href="create_coaching_program_type_master" class="btn btn-primary btn-wave">
										Add Coaching Program Type
									</a>
								</div>
							</div>
							<div class="card-body">
								<div class="table-responsive">
									<table id="example1" class="table table-bordered text-nowrap w-100">
										...
										<tbody>
											...
											foreach ($coaching_program_type_list as $row) :
												$no++;
												$coaching_program_type_id = $row->entity_id;
											...
											?>
												...
												<td>
														<a href="<?php echo site_url('edit_coaching_program_type_master/'.$coaching_program_type_id); ?>" class="btn btn-sm btn-info" data-bs-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
													</td>
