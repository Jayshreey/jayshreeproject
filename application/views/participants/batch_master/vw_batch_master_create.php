	...
	<div class="page">
		...
		<div class="main-content app-content">
			<div class="container-fluid">
					...
					<div class="my-auto">
						...
						<nav>
							<ol class="breadcrumb mb-0">
								...
								<li class="breadcrumb-item"><a href="vw_batch_master">Batch Master</a></li>
								<li class="breadcrumb-item active" aria-current="page">Create Batch Master</li>
							</ol>
						</nav>
					</div>
				</div>
				...
				<form role="form" name="customer_master" action="<?php echo site_url('participants/batch_master/save_batch_details'); ?>" method="post">
					<div class="row">
						<div class="col-xl-12">
							<div class="card custom-card">
								<div class="card-header">
									<div class="card-title">Batch Master Form</div>
								</div>
								<div class="card-body">
									...
									<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											...
											<select class="form-select batch_fields" id="coaching_program_type_id" name="coaching_program_type_id" required>
									...
									<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											...
											<select class="form-select batch_fields" id="mode" name="mode" required>
										...
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											...
											<input type="text" class="form-control batch_fields" name="locality" id="locality" placeholder="Enter Locality" required>
										</div>

										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											<label for="input-placeholder" class="fw-semibold mb-2">Day<span style="color: #FF0000;">*</span></label>
											<select class="form-select batch_fields" id="day" name="day" required>
										...
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											...
											<input type="text" class="form-control batch_fields" name="timing" id="timing" placeholder="Enter Timing" required>
										</div>

										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											<p class="fw-semibold mb-2">Batch SPOC<span style="color: #FF0000;">*</span></p>
											<select class="form-select batch_fields" id="spoc_id" name="spoc_id">
										...
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											...
											<input type="text" class="form-control" name="batch_name" id="batch_name" placeholder="Enter First Name" required>
										</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('.batch_fields').change(function() {
				...
				var batch_name = coaching_program_type+" "+mode+" "+locality+" "+day+" "+timing;
