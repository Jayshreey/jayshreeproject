		...
		<div class="main-content app-content">
			<div class="container-fluid">
				...
				<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
					<div class="my-auto">
						<h5 class="page-title fs-21 mb-1">Coaching Program Master</h5>
						<nav>
							<ol class="breadcrumb mb-0">
								<!-- <li class="breadcrumb-item" aria-current="page"> Master</li> -->
								<li class="breadcrumb-item"><a href="vw_company_master">Coaching Program Master</a></li>
								<li class="breadcrumb-item active" aria-current="page">Create Coaching Program Master</li>
							</ol>
						</nav>
					</div>
				</div>
				...
				<form role="form" name="customer_master" action="<?php echo site_url('participants/coaching_program_master/save_coaching_program_details'); ?>" method="post">
					<div class="row">
						<div class="col-xl-12">
							<div class="card custom-card">
								<div class="card-header">
									<div class="card-title">Coaching Program Master Form</div>
								</div>
								<div class="card-body">
									...
									<div class="row gy-4">
										...
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											...
											<input type="text" class="form-control" name="coaching_program_name" id="coaching_program_name" placeholder="Enter Coaching Program Name" required>
										</div>


										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											<label for="input-placeholder" class="fw-semibold mb-2">Remark<span style="color: #FF0000;">*</span></label>
											<input type="text" class="form-control" name="remark" id="remark" placeholder="Enter Remark" required>
										</div>
