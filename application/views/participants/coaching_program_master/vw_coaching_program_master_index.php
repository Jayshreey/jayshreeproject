					...
					<div class="my-auto">
						...
						<nav>
							<ol class="breadcrumb mb-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Level Master</li>
							</ol>
						</nav>
					</div>
				</div>
					...
					<div class="col-xl-12">
						<div class="card custom-card">
							<div class="card-header">
								<div class="card-title">Level Master</div>
							</div>
							<div class="card-body">
								<div class="btn-list">

									<a href="create_coaching_program_master" class="btn btn-primary btn-wave">
										Add Level
									</a>
								</div>
							</div>
								...
								<div class="table-responsive">
									<table id="example1" class="table table-bordered text-nowrap w-100">
										...
										<tbody>
											...
											foreach ($coaching_program_list as $row) :
												$no++;
												$coaching_program_id = $row->entity_id;
											...
											?>
												<tr>
													<td><?php echo $no; ?></td>
													<td>
														<?php echo $row->coaching_program_name; ?>
													</td>
													<td>
														<?php echo ($row->status ==1)? "Active" : "In-Active"; ?>
													</td>
												<td>
														<a href="<?php echo site_url('edit_coaching_program_master/'.$coaching_program_id); ?>" class="btn btn-sm btn-info" data-bs-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
													</td>
