		...
		<div class="main-content app-content">
			<div class="container-fluid">
				...
				<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
					<div class="my-auto">
						<h5 class="page-title fs-21 mb-1">Daily Diary Master</h5>
						<nav>
							<ol class="breadcrumb mb-0">
								<li class="breadcrumb-item" aria-current="page"> Master</li>
								<li class="breadcrumb-item"><a href="vw_company_master">Daily Diary Master</a></li>
								<li class="breadcrumb-item active" aria-current="page">Create Daily Diary Master</li>
							</ol>
						</nav>
					</div>
				</div>
				...
				<form role="form" name="customer_master" action="<?php echo site_url('company/worklog/daily_diary_master/save_daily_diary_details'); ?>" method="post"  enctype="multipart/form-data">
					<div class="row">
						<div class="col-xl-12">
							<div class="card custom-card">
								<div class="card-header">
									<div class="card-title">Daily Diary Master Form</div>
								</div>
								<div class="card-body">

									<div class="row gy-4">
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											<p class="fw-semibold mb-2">Employee Name<span style="color: #FF0000;"></span></p>
											<select class="form-select" id="sparrow_employee_id" name="sparrow_employee_id" required>
												...
												<?php foreach ($sparrow_employee_list as $sparrow_employee) : ?>
													<option value="<?php echo $sparrow_employee->entity_id; ?>" <?php echo ($sparrow_employee->entity_id == $sparrow_employee_id) ? "selected" : ""; ?>><?php echo $sparrow_employee->sparrow_employee_name; ?></option>
												<?php endforeach; ?>
											</select>
										</div>
										
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											<label for="input-placeholder" class="fw-semibold mb-2">Diary Date<span style="color: #FF0000;">*</span></label>
											<input type="date" class="form-control" name="diary_date" id="diary_date" placeholder="Select Diary Date" value="<?php echo $today_date; ?>" required>
										</div>


										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											<label for="input-placeholder" class="fw-semibold mb-2">Upload Diary<span style="color: #FF0000;">*</span></label>
