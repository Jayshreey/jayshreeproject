...
<head>
    ...
    <title> VBDigitech-Sparrow </title>
    ...
    <!-- Main Theme Js -->
    <script src="<?php echo base_url().'assets/HTML/dist/assets/js/authentication-main.js'?>"></script>
    ...
    <!-- Icons Css -->
    <link rel="stylesheet" href="<?php echo base_url().'assets/HTML/dist/assets/css/icons.min.css'?>">
...
<body>
        ...
        <div class="row bg-white">
            ...
            <div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent-3">
                <div class="row w-100 mx-auto text-center">
                    <div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto w-50">
                        <img class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo" src="<?php echo base_url().'assets/HTML/dist/assets/images/media/pngs/logo.png'?>">
                    </div>
                </div>
            </div>
            <!-- The content half -->
                                        ...
                                        <div class="main-signup-header">
                                            ...
                                            <form action="welcome/process" method="post">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label class="form-label">User Name</label> <input class="form-control"
                                                        placeholder="Enter your User Name" name="user_name" id="user_name" type="text">
                                                </div>
                                                <div class="form-group mb-3">
    ...
    <!-- Show Password JS -->
    <script src="<?php echo base_url().'assets/HTML/dist/assets/js/show-password.js'?>"></script>
