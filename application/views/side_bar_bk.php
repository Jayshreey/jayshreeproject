                ...
                <ul class="main-menu">
                    ...
                    <li class="slide has-sub">
                        ...
                        <ul class="slide-menu child1">
                            ...
                            <li class="slide">
                                <a href="<?php echo base_url().'vw_customer_master'?>" class="side-menu__item" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Customer Master">Customer Master</a>
                            </li>
                            <!-- <li class="slide">
                    ...
                    <!-- <li class="slide__category"><span class="category-name">Masters</span></li> -->
                    <!-- End::slide__category -->
                    ...
                    <!-- <li class="slide">
                        <a href="index.html" class="side-menu__item">
                            ...
                            <b class="side-menu__icon" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Customer Master" viewBox="0 0 24 24"><i class="mdi mdi-account"></i></b>
                            <span class="side-menu__label">Customer Master</span>
                        </a>
                    </li> -->
                    <!-- End::slide -->
