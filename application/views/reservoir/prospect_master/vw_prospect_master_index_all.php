						...
						<div class="card custom-card">
							...
							<div class="card-body">
								<div class="btn-list">
									...
									<a href="vw_prospect_master" class="btn btn-outline-secondary btn-wave ">
										Open NCA Reservoir
									</a>
								</div>
							</div>
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td>
														<a href="<?php echo base_url('edit_prospect_master/'.$prospect_id); ?>"  title="Edit"><i class="fas fa-edit"></i></a>
