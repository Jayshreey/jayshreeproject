	...
	<div class="page">
		...
		<div class="main-content app-content">
			<div class="container-fluid">
					...
					<div class="my-auto">
						...
						<nav>
							<ol class="breadcrumb mb-0">
								...
								<li class="breadcrumb-item"><a href="vw_prospect_master">NCA Reservoir</a></li>
				...
				<form role="form" name="customer_master" action="<?php echo site_url('reservoir/prospect_master/save_prospect'); ?>" method="post">
					<div class="row">
						<div class="col-xl-12">
								...
								<div class="card-body">
									...
									<div class="row gy-4">
										...
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											...
											<input type="text" class="form-control" name="company_name" id="company_name" placeholder="Enter Company_name">
										</div>
										...
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 ">
											...
											<textarea class="form-control company_element" id="programs_interested_in" name="programs_interested_in" rows="3" placeholder="Enter Programs Interested in" required></textarea>
										</div>
									...
									<div class="row gy-4">
										...
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 ">
											...
											<textarea class="form-control company_element" id="address" name="address" rows="3" placeholder="Enter Address" ></textarea>
										</div>
										...
										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 ">
											...
											<input type="text" class="form-control company_element" name="locality" id="locality" placeholder="Enter Locality" >
										</div>

										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 ">
											<label for="input-number" class="fw-semibold mb-2">Pin Code <span style="color: #FF0000;"></span></label>
											<input type="number" class="form-control company_element" name="pincode" id="pincode" placeholder="Enter Pin Code">
										</div>

										<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											<p class="fw-semibold mb-2">SPOC<span style="color: #FF0000;">*</span></p>
											<select class="js-example-basic-single company_element" data-trigger id="assigned_to" name="assigned_to" required>
										...
										<!-- <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
											<label for="input-placeholder" class="fw-semibold mb-2">Stage<span style="color: #FF0000;">*</span></label>
											<select class="form-select" id="conversion_stage" name="conversion_stage" required>
												<option value="">No Selected</option>
