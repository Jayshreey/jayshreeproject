...
class Coaching_program_type_master extends CI_Controller {
    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->model('coaching_program_type_master_model');
        $this->load->library('session');
    }

    public function index()
    {
        $data['coaching_program_type_list'] = $this->coaching_program_type_master_model->get_coaching_program_type_list();
        $this->load->view('participants/coaching_program_type_master/vw_coaching_program_type_master_index',$data);
    }

   public function create()
    {
        
        $this->load->view('participants/coaching_program_type_master/vw_coaching_program_type_master_create');
    }

	
	public function save_coaching_program_type_details()
	{
       $coaching_program_type = $this->input->post('coaching_program_type');
       
		$coaching_program_type_insert_array = array(
			
			'coaching_program_type' => $coaching_program_type,
			'status' => 1
		);

		$coaching_program_type_id = $this->coaching_program_type_master_model->save_coaching_program_type($coaching_program_type_insert_array);

		redirect('vw_coaching_program_type_master');
	}

	
    public function edit_coaching_program_type_master()
    {
        $coaching_program_type_id = $this->uri->segment(2);
        $data['coaching_program_type_id'] = $coaching_program_type_id;
        $data['coaching_program_type_details'] = $this->coaching_program_type_master_model->get_coaching_program_type_details($coaching_program_type_id);
       
        $this->load->view('participants/coaching_program_type_master/vw_coaching_program_type_master_edit',$data);
    }


    public function create_participant()
    {
        $data['state_list'] = $this->coaching_program_type_master_model->get_state_list();
        $data['company_list'] = $this->coaching_program_type_master_model->get_company_list();
        $data['spoc_list'] = $this->coaching_program_type_master_model->get_spoc_list();
        $data['source_list'] = $this->coaching_program_type_master_model->get_source_list();
    ...
    public function get_city_name()
    {
        ...
        $data = $this->coaching_program_type_master_model->get_city_model_data($state_id)->result();
    ...
    public function check_customer_name()
    {
        ...
        if(!empty($data))
        {
            ...
            $data = $this->coaching_program_type_master_model->check_customer_name_model($customer_name);
            if($data == 'true')
            {
                print_r($data);
    ...
    public function save_company_details()
    {
		...
		$customer_id = $this->coaching_program_type_master_model->save_company($customer_array);
    ...
    public function edit_company_master()
    {
        ...
        $data['company_details'] = $this->coaching_program_type_master_model->get_company_details($company_id);
        $data['participant_list'] = $this->coaching_program_type_master_model->get_participant_list_by_company_id($company_id);
        ...
        $data['source_list'] = $this->coaching_program_type_master_model->get_source_list();
        $data['state_list'] = $this->coaching_program_type_master_model->get_state_list();
        $data['city_list'] = $this->coaching_program_type_master_model->get_city_list();
    ...
    public function get_company_details_by_id()
    {
        ...
        if(!empty($data))
        {
            ...
            $data = $this->coaching_program_type_master_model->get_company_details_by_id($company_id);
            echo json_encode($data);
        }
    }
	...
	public function add_new_participant()
	{
		...
		$participant_id = $this->coaching_program_type_master_model->save_participant($participant_insert_array);
    ...
    public function update_state()
    {
        ...
        $data = $this->coaching_program_type_master_model->update_address_relation($update_array);
    ...
    public function update_coaching_program_type()
    {
        $coaching_program_type_id = $this->input->post('coaching_program_type_id');
        $coaching_program_type = $this->input->post('coaching_program_type');
        $status = $this->input->post('status');

        $coaching_prgram_type_update_array = array(
			'entity_id' => $coaching_program_type_id,
			'coaching_program_type' => $coaching_program_type,
			'status' => $status
		);

        $result = $this->coaching_program_type_master_model->update_coaching_program_type($coaching_program_type_id,$coaching_prgram_type_update_array);
    ...
    public function update_contactperson()
    {
        ...
        $data = $this->coaching_program_type_master_model->update_contact_relation($update_array);
    ...
    public function edit_customer_master_data()
    {
        ...
        // $data = $this->coaching_program_type_master_model->update_customer_master($update_array);
    ...
    public function update_customer_master()
    {
        ...
        $data['customer_contact_details'] = $this->coaching_program_type_master_model->get_customer_only_contact_details($entity_id);
        $data['state_list'] = $this->coaching_program_type_master_model->get_state_list();
        $data['city_list'] = $this->coaching_program_type_master_model->get_city_list();
    ...
    public function view_customer_master()
    {
        $entity_id = $this->uri->segment(2);
        $data['entity_id'] = $entity_id;
        $data['customer_details'] = $this->coaching_program_type_master_model->get_customer_address_details($entity_id);
        ...
        $data['customer_type_list'] = $this->coaching_program_type_master_model->get_customer_types();
        $data['state_list'] = $this->coaching_program_type_master_model->get_state_list();
        $data['city_list'] = $this->coaching_program_type_master_model->get_city_list();
        $data['spoc_list'] = $this->coaching_program_type_master_model->get_spoc_list();
    ...
    public function get_state_code()
    {
        ...
        if(!empty($data))
        {
            ...
            $data = $this->coaching_program_type_master_model->get_state_code_by_state_id($state_id);
            echo json_encode([$data]);
        }
    }
    ...
    public function get_state_id()
    {
        ...
        if(!empty($data))
        {
            ...
            $data = $this->coaching_program_type_master_model->get_state_id_data($entity_id)->result();
            echo json_encode($data);
        }
    }
    ...
    {
        $entity_id = $this->uri->segment(2);
        $data = $this->coaching_program_type_master_model->soft_delete_coaching_program_type_master_model($entity_id);
        redirect('vw_customer_master');
    }
